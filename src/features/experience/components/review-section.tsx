...
import { getRatingSatisfactionLabel } from "../lib/experience-detail.utils";
...
function ReviewSection({
  ...
  const totalReviews = reviewCount ?? reviews?.totalCount ?? 0;
  const satisfactionLabel = getRatingSatisfactionLabel(rating, totalReviews);

  return (
    <div>
        <div className="flex gap-2 justify-start items-center mb-2">
            <h2 className="text-body-18">체험 후기</h2>
            <p className="text-body-16 text-[#79747E]"> {totalReviews}개</p>
        </div>
