...
function ReservationCard({
  ...
  const openDatePickerSheet = () => {
    openModal("slide", {
      children: (
        <div className="max-h-[min(85vh,640px)] overflow-y-auto tablet:py-6 tablet:px-[30px] py-3">
          <div className="flex flex-col gap-6 tablet:flex-row tablet:items-start tablet:gap-6">
            <div className="shrink-0 tablet:max-w-[min(100%,320px)] tablet:min-w-[240px]">
            ...
            <div className="flex min-w-0 flex-1 flex-col gap-9 tablet:shadow-[0px_4px_24px_0px_#9CB4CA33] rounded-3xl tablet:p-[30px] p-[20px]">
              ...
              <div className="flex tablet:flex-col justify-between gap-5 tablet:items-start items-center tablet:my-0 my-0">
                <h3 className="text-16 font-bold">참여 인원수</h3>
                <div className="tablet:w-full tablet:justify-between flex items-center rounded-full ring ring-[#eee] overflow-hidden px-[9px]">
          ...
          <Button
            type="button"
            variant="default"
            className="mt-4 w-full rounded-[14px] bg-primary-500 !text-white text-16 font-bold h-[48px]"
            onClick={closeModal}
          >
            확인
          </Button>
      ...
      >
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-1">
            <h2 className="text-18 font-bold">₩ {price?.toLocaleString()}</h2>
