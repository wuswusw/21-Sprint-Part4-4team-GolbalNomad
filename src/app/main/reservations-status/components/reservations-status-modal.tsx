...
function ReservationsStatusModal() {
    const [activeTab, setActiveTab] = useState<Tab>("신청");

    return (
        <div className="w-85 px-6 py-[30px] bg-white rounded-3xl flex flex-col gap-[30px] shadow-[0_4px_24px_0_#9CB4CA33]">
            <div className="flex flex-col gap-3 items-start relative">
                <h2 className="text-20 font-bold">2026년 03월 17일</h2>
                <img src="/assets/icons/delete.svg" alt="close" className="absolute top-0 right-0" />
...
export default ReservationsStatusModal;